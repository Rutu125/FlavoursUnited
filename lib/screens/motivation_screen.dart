...
import 'package:flavours_united/storage_services/storage_services_motivation.dart';
import 'package:flutter/material.dart';
import 'package:firebase_storage/firebase_storage.dart';

FirebaseStorage storage = FirebaseStorage.instance;
final _fire = FirebaseFirestore.instance.collection('motivationURL');

class MotivationScreen extends StatefulWidget {
  static String id = 'motivation_screen';
...
class _MotivationScreenState extends State<MotivationScreen> {
  ...
  Widget build(BuildContext context) {
    final StorageMM storage = StorageMM('foodVideos');
